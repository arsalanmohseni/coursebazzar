    ...
    return (
        <div>
            ...
            <p className="mt-6 text-center text-xl text-black dark:text-white">
                ...
                lobortis mattis aliquam faucibus purus. Sapien faucibus et molestie ac feugiat sed. Eget nunc
                scelerisque viverra mauris. Nunc sed augue lacus viverra. Nulla malesuada pellentesque elit eget. Nibh
